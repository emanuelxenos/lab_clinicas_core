...
mixin MessageViewMixin<T extends StatefulWidget> on State<T> {
  void messageListener(MessageStateMixi state) {
    effect(() {
      switch (state) {
        case MessageStateMixi(:final errorMessage?):
          Messages.showError(errorMessage, context);
        case MessageStateMixi(:final infoMessage?):
          Messages.showInfo(infoMessage, context);
        case MessageStateMixi(:final successMessage?):
